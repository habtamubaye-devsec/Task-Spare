...
export default function RegisterPage() {
    ...
    return (
      ...
      >
        <div className="mt-8 p-6 bg-teal-50 rounded-2xl text-center border border-teal/10">
          ...
          <h3 className="font-semibold text-lg text-gray-900 mb-2">Verification Sent</h3>
          <p className="text-gray-600 text-sm">Please click the link in your email to verify your account.</p>
  ...
  return (
    <AuthLayout
      ...
      subtitle="Join TaskIQ today and start optimizing your workflow."
    >
      <form onSubmit={handleSubmit} className="mt-8 space-y-5">
        ...
        <p className="mt-8 text-center text-sm text-gray-600">
          ...
          <Link href="/login" className="font-semibold text-teal hover:underline hover:text-teal-dark">
            Log in
          </Link>
        </p>
      </form>
